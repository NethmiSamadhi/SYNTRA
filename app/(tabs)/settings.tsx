...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Absolutely! SYNTRA is a local-first app, meaning all your data is stored on your device. You only need an internet connection for optional features like AI-powered insights or cloud backups.',
  },
];
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor }]} edges={['top']}>
      ...
      >
        ...
        >
          <Text style={[styles.appName, { color: textPrimary }]}>SYNTRA</Text>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA collects the following information to provide you with financial management services:
          </Text>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA uses the following third-party services only when explicitly requested:
          </Text>
          <Text style={[styles.modalBulletPoint, { color: textSecondary }]}>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA is not intended for users under the age of 13. We do not knowingly collect personal information from children under 13.
          </Text>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            By accessing and using SYNTRA, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, please do not use the application.
          </Text>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA is a personal finance management application that helps you track accounts, manage transactions, plan budgets, and receive AI-powered financial insights. The service is provided "as is" for your personal use.
          </Text>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA is a tool to help you manage your finances. However:
          </Text>
          <Text style={[styles.modalBulletPoint, { color: textSecondary }]}>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            You are responsible for the accuracy of all financial data you enter into SYNTRA. We are not liable for any errors, omissions, or inaccuracies in the data you provide.
          </Text>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            SYNTRA is provided "as is" without warranties of any kind. We are not liable for any direct, indirect, incidental, or consequential damages arising from your use of the service, including but not limited to financial losses or data loss.
          </Text>
          ...
          <Text style={[styles.modalContent, { color: textSecondary }]}>
            All content, features, and functionality of SYNTRA are owned by us and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, or distribute any part of the service without our permission.
          </Text>
      ...
      >
        ...
        >
          ...
          <View style={[styles.modalInfoCard, { backgroundColor: cardBackground, borderColor }]}>
            <Text style={[styles.modalContent, { color: textSecondary }]}>
              Welcome to SYNTRA! Here's how to get started:
            </Text>
